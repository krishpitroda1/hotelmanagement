...
def Booking():
        ...
        #n=int(input("enter number of day for live"))
...
class hotel:
    ...
    def menu(self):
        user_input=input("""
        hi sir welcome to our hotel.
        how may i help you?
        1.press 1 for booking(please see rooms type before booking by pressing 2 before press 1) 
        2.press 2 for rooms information
        3.press 3 for room services like order a food
        4.press 4 for payment
        5.exit
        """)
        if user_input=='1':
            self.booking()
            ...
            print("please enter in 1 to 5")
    def booking(self):
        print("\n sir welcome to our hotel")
        user_name=str(input("please enter your name"))
        user_mobilenum=int(input("please enter your mobile num"))
        user_address=str(input('enter your address'))
        user_room=str(input("""enter which type of you room select
        for this go to menu and see full information of rooms"""))
        self.name=user_name
        self.mobilenum=user_mobilenum
        ...
        print("your room type is:",self.room)
        print("your id is:",self.id)
        print("mobile number:",self.mobilenum)
        self.menu()
    def rooms_info(self):
        print("         ------ HOTEL ROOMS INFO ------")
        print("")
...
#         n_name=input("please sir enter name")
#         n_num=input("please sir enter your mobile num")
#        
        user_room=input("enter your  room no")
        f=0
        r=0
        if  user_room==self.roomno:
            f=1
            print("\n---------------------Menu Card---------------------------")
            print("\n press according menu card")
            print("-------------------------------------------------------------------------")
            print("\n BEVARAGES                              26 Dal Fry................ 140.00")
            print("----------------------------------      27 Dal Makhani............ 150.00")
            print(" 1  Regular Tea............. 20.00      28 Dal Tadka.............. 150.00")
